...
################################################################################
## Form generated from reading UI file 'persistent_search_page.ui'
##
...
class Ui_w_addPersistentApps(object):
    def setupUi(self, w_addPersistentApps):
        if not w_addPersistentApps.objectName():
            w_addPersistentApps.setObjectName(u"w_addPersistentApps")
        w_addPersistentApps.setWindowModality(Qt.ApplicationModal)
        w_addPersistentApps.setEnabled(True)
        w_addPersistentApps.resize(525, 377)
        icon = QIcon()
        icon.addFile(u":/Logo/logo.png", QSize(), QIcon.Normal, QIcon.Off)
        w_addPersistentApps.setWindowIcon(icon)
        w_addPersistentApps.setAutoFillBackground(False)
        self.gridLayout = QGridLayout(w_addPersistentApps)
        self.gridLayout.setObjectName(u"gridLayout")
        self.gb_main = QGroupBox(w_addPersistentApps)
        ...
        self.retranslateUi(w_addPersistentApps)

        QMetaObject.connectSlotsByName(w_addPersistentApps)
    # setupUi

    def retranslateUi(self, w_addPersistentApps):
        w_addPersistentApps.setWindowTitle(QCoreApplication.translate("w_addPersistentApps", u"Nutshell | Persistent Application Search", None))
        self.gb_main.setTitle(QCoreApplication.translate("w_addPersistentApps", u"Application Search (Persistent)", None))
        self.gb_firefox.setTitle(QCoreApplication.translate("w_addPersistentApps", u"Firefox", None))
        self.pb_firefox.setText("")
        self.gb_fedora.setTitle(QCoreApplication.translate("w_addPersistentApps", u"Fedora", None))
        self.pb_fedora.setText("")
        self.gb_chromium.setTitle(QCoreApplication.translate("w_addPersistentApps", u"Chromium", None))
        self.pb_chromium.setText("")
        self.gb_arch.setTitle(QCoreApplication.translate("w_addPersistentApps", u"Arch", None))
        self.pb_arch.setText("")
        self.gb_ubuntu.setTitle(QCoreApplication.translate("w_addPersistentApps", u"Ubuntu", None))
        self.pb_ubuntu.setText("")
        self.gb_opera.setTitle(QCoreApplication.translate("w_addPersistentApps", u"Opera", None))
        self.pb_opera.setText("")
        self.gb_debian.setTitle(QCoreApplication.translate("w_addPersistentApps", u"Debian", None))
        self.pb_debian.setText("")
        self.gb_alpine.setTitle(QCoreApplication.translate("w_addPersistentApps", u"Alpine", None))
        self.pb_alpine.setText("")
        self.gb_libreoffice.setTitle(QCoreApplication.translate("w_addPersistentApps", u"LibreOffice", None))
